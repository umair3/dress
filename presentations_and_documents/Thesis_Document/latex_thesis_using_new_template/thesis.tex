...
This research digs into the currently adopted solutions, standards and the new research. It suggests a prototype infrastructure including data format and the architecture to exchange degree records digitally. For making it successful, our proposed infrastructure should be less error prone and easy to implement. To achieve this goal, we suggest a mapping tool which semi-automatically maps universities’ datasets to our proposed standard and creates web-services to access their data.
