	...
	<div class="full-width feature">
		<div class="column-wrap talking-points dim leadin">
			<div class="wizard-steps">
			  ...
			  <div class="completed-step"><a href="<?php echo base_url().index_page().'/wizard/review_maps/'; ?>"><span>3</span> Review Maps</a></div>
			  <div class="active-step"><a href="#"><span>4</span> Finish</a></div>
			</div>
		</div>
	</div>
